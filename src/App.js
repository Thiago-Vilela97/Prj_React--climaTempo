...
function App() {
  ...
  const handleSearch = () => {
    fetch(`http://api.weatherapi.com/v1/current.json?key=a0b9eeb060bc44b3b33173646222803&q=${city}&lang=pt`)
    .then((response) => {
    ...
    <div>
      <nav className="navbar navbar-expand-md navbar-dark bg-dark mb-4" >
        <a className="navbar-brand text-white" href="#top">
          Thiago, Previsão do tempo
        </a>
      </nav>

    <main className="container" >
      <div className="jumbotron" >
        <h1> Verifique agora a previsão de tempo da sua cidade</h1>
        <p className="lead">
        ...
        <div className="row mb-4">
          <div className="col-md-6">
            ...
            className="form-control" value={city} placeholder="Another Location" />
          </div>
        </div>
